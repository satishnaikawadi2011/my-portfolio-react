			...
			<div className="section__center">
				<div className={styles.left__half}>
					<p className={styles.about__text}>
						Lorem ipsum dolor sit amet consectetur, adipisicing elit. Earum sit quaerat unde odit reiciendis
						est quia id dignissimos in esse, veniam quod, maxime cupiditate nam fugiat corporis labore
						voluptates animi
					</p>
